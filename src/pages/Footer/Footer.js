        ...
        <div className='bg-neutral text-white'>
            <footer className="footer p-10 ">
                <div>
                    ...
                    <Link className="link link-hover">Our offering</Link>
                    <Link className="link link-hover">Gift cards</Link>
                    <Link className="link link-hover">Newsroom</Link>
                    <Link className="link link-hover">Blog</Link>
                </div>
                <div>
                    <span className="footer-title">Products</span>
                    <Link className="link link-hover">Fashion</Link>
                    <Link className="link link-hover">Fashion</Link>
                    <Link className="link link-hover">Electronics</Link>
                    <Link className="link link-hover">Home Applicances</Link>
                </div>
                <div>
